...
<body>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-3">
          <h1 class="my-4">Model Enhancement for AI-based Anomaly Detection in Manufacturing</h1>
      </div>
      <!--메인페이지 상단부분 -->
      <div class="col-lg-9">       
        <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              <img class="d-block img-fluid" src="main_image/mainimage4.PNG" alt="First slide" 
