	...
	<nav class="navbar navbar-inverse"> <!-- navbar-색상(inverse = 검은색, default 22222= 색x) -->
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav"> <!-- navbar-nav => 네비게이션 바의 메뉴 -->
				...
				<li class="active"><a href="userBoard.jsp">자유게시판</a></li>
				<li class="active"><a href="../userPictureBoard-all/userPictureBoard.jsp">사진게시판</a></li>
			...
			<%			
				...
				try {										
				  ...
				  String pwd = "1111";
				   ...
				   String sql = "select * from 자유게시판 order by 게시판번호 desc";				   
			     ...
			     int count = 0; 
				   while(rs.next()){					   
						   ...
						   out.print("<td>"); 
%> 
							 <a href='BoardList.jsp?board_no=<%=board_no%>'> 
<% 							
...
%>
			...
			<a href="BoardScanf.jsp" class="btn btn-primary pull-right">글쓰기</a>
		</div>
	</div>
